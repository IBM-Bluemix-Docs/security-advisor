...
{: class="simple-tab-table"}
{: caption="Table 3. Low severity edge protection findings and their remediation steps" caption-side="top"}
{: #edge-protection-low}
...
{: class="simple-tab-table"}
{: caption="Table 4. High severity COS findings and their remediation steps" caption-side="top"}
{: #cos-high}
{: tab-title="High severity"}
{: tab-group="cos"}
...
{: class="simple-tab-table"}
{: caption="Table 5. Medium severity COS findings and their remediation steps" caption-side="top"}
{: #cos-medium}
{: tab-title="Medium severity"}
{: tab-group="cos"}
...
{: class="simple-tab-table"}
{: caption="Table 6. High severity IAM findings and their remediation steps" caption-side="top"}
{: #iam-high}
{: tab-title="High severity"}
{: tab-group="iam"}
...
{: class="simple-tab-table"}
{: caption="Table 7. Medium severity IAM findings and their remediation steps" caption-side="top"}
{: #iam-medium}
{: tab-title="Medium severity"}
{: tab-group="iam"}
