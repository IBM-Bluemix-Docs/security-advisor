...
5. Select **Test the connection**. A test notification is sent to your endpoint.
   - A test channel connection request will trigger an alert with content as shown below:
     ```
     {
     ...
     ``` 
     **Note**: Make sure that you ignore test alerts with above `issuer` in your webhook implementation.
